...
public class RightShooterCharacterization extends CharacterizationBase {
    private final Shooter shooter;
    
    public RightShooterCharacterization(Shooter shooter) {
    ...
    public void setVoltage(double volts) {
        shooter.setRightVoltage(volts);
    }

    @Override
    public double getMotorVoltage() {
        return shooter.getRightVoltage();
    }
